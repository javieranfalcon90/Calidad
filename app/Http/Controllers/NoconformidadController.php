...
class NoconformidadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return dataTables()->of($data)
                ...
                ->rawColumns(['codigo', 'descripcion', 'fuente_id', 'proceso_id', 'requisito_id', 'fechanotificacion', 'estado'])
        ...
        return view('noconformidad.index', compact('fuentes', 'procesos', 'requisitos'));
    }
    ...
    public function create()
    {
        ...
        return view('noconformidad.create', compact('noconformidad', 'fuentes', 'procesos', 'requisitos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('noconformidad.edit', compact('noconformidad', 'fuentes', 'procesos', 'requisitos'));
    }
