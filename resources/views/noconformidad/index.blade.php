        ...
        $(function () {
            ...
            $('.filter-button').click(function (e) {
                ...
                if((fechanotificacion != '') || (fechacierre != '') || (proceso != "") || (fuente != "") || (clasificacion != "") || (requisito != "")){
                    ...
                    var route = '{!! Route("noconformidades.index", ["fechanotificacion" => "paramfechanotificacion","fechacierre" => "paramfechacierre","proceso" => "paramproceso","fuente" => "paramfuente","requisito" => "paramrequisito"]) !!}'; 
