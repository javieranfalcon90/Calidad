<div class="row g-3">
    ...
    <div class="col-4">
        <label class="form-label">Período de Cumplimiento</label>
        {{ Form::select('periodo', ['Mensual' => 'Mensual', 'Bimestral' => 'Bimestral', 'Trimestral'=>'Trimestral', 'Semestral'=>'Semestral', 'Anual'=>'Anual'], $accion->periodo, ['class' => 'form-control select2' . ($errors->has('periodo') ? ' is-invalid' : ''), 'placeholder' => '']) }}
